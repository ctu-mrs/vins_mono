...
'
  'Republisher' 'waitForRos; roslaunch vins_republish vins_republish.launch
'
  'Camera' 'waitForRos; roslaunch bluefox2 single_nodelet device:=25003659 aec:=1 rate:=30
'
  'IMU' 'waitForRos; roslaunch xsens_mti_driver xsens_mti_node.launch
'
